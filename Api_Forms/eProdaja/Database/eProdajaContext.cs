...
namespace eProdaja.Database
{
    public partial class eProdajaContext : DbContext
    {
        ...
        public virtual DbSet<PretragaIspit> PretragaIspits { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<PretragaIspit>(entity =>
            {
                entity.ToTable("PretragaIspit");

                entity.Property(e => e.PretragaIspitId).HasColumnName("PretragaIspitID");
                ...
                entity.HasOne(d => d.Korisnik)
                    .WithMany(p => p.PretragaIspits)
                    .HasForeignKey(d => d.KorisnikId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_PretragaIspit_Korisnici");

                entity.HasOne(d => d.VrstaProizvoda)
                    .WithMany(p => p.PretragaIspits)
                    .HasForeignKey(d => d.VrstaProizvodaId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_PretragaIspit_VrsteProizvoda");
            });
